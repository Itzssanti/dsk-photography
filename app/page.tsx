  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex flex-col justify-end pb-24 px-8 md:px-16 overflow-hidden">
        ...
        <div className="absolute inset-0" style={{ background: "linear-gradient(to top, rgba(0,0,0,0.72) 0%, rgba(0,0,0,0.18) 55%, rgba(0,0,0,0.05) 100%)", zIndex: 1 }} />

        <div className="relative max-w-5xl" style={{ zIndex: 2 }}>
          <p className="section-label mb-8 animate-fade-up" style={{ color: "rgba(255,255,255,0.55)" }}>
            Real Estate Photography · San Jose, CA
          </p>

          <h1 className="font-display animate-fade-up delay-1"
              style={{ fontSize: "clamp(52px, 8vw, 120px)", lineHeight: 0.95, fontWeight: 300, letterSpacing: "-0.02em", color: "#fff" }}>
            Spaces that<br />
            <em style={{ fontStyle: "italic" }}>compel</em> a<br />
            second look<span style={{ color: "var(--gold)" }}>.</span>
          </h1>

          <p className="animate-fade-up delay-2 mt-8"
             style={{ fontSize: "15px", color: "rgba(255,255,255,0.65)", maxWidth: "420px", lineHeight: 1.7 }}>
          ...
          <div className="flex items-center gap-8 mt-12 animate-fade-up delay-3">
            <a href="#contact"
               ...
               style={{ background: "#fff", color: "var(--ink)", letterSpacing: "0.18em", fontWeight: 500, textDecoration: "none", transition: "opacity 0.25s cubic-bezier(0.22,1,0.36,1)" }}
            ...
            <a href="#portfolio"
               ...
               style={{ fontSize: "10px", letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(255,255,255,0.6)", textDecoration: "none", transition: "color 0.25s cubic-bezier(0.22,1,0.36,1)" }}
        ...
        {/* Bottom meta */}
        <div className="absolute bottom-8 right-8 md:right-16 flex items-center gap-6 animate-fade-in" style={{ zIndex: 2 }}>
          <span className="section-label" style={{ color: "rgba(255,255,255,0.45)" }}>Sony FX30</span>
          <div className="h-px w-12" style={{ background: "rgba(255,255,255,0.25)" }} />
          <span className="section-label" style={{ color: "rgba(255,255,255,0.45)" }}>Bay Area</span>
        </div>
      </section>
